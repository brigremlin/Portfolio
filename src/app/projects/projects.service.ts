...
export class ProjectsService {
  projects: Projects[] = [
    ...
    {name: "getFRIENDED Web Application", image: "../../assets/getFriended.PNG", about:"A web application implementing user authentication and services to store and manipulate user data", url:"https://getfriended-be40a.firebaseapp.com/", id:3}
